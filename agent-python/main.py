...
def main() -> None:
    ...
    print(
        ...
        "'ask-tools <message>', 'runtime', 'checkpoint', or 'exit' to quit."
    )
    ...
    while True:
        ...
        if normalized_message == "runtime":
            ...
            from graph_runtime import format_runtime_context

            print(format_runtime_context(AGENT_THREAD_ID))
            continue
